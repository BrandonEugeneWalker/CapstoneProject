...
namespace Capstone_Desktop.Controller
{
    ...
    public class ManageItemsController
    {
        ...
        /// <summary>
        ///   <para>
        ///  Gets and returns all the Stock objects in the database.</para>
        ...
        public List<StockDetailView> GetAllStock(OnlineEntities capstoneDbContext)
        {
            ...
            {
                throw new ArgumentNullException(nameof(capstoneDbContext), @"The database to get stock from cannot be null!");
            }
